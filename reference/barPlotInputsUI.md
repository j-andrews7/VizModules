...
#> <div class="tabbable">
#>   <ul class="nav nav-tabs shiny-tab-input" id="BarPlot-BarPlotTabsetPanel" data-tabsetid="9297">
#>     <li class="active">
#>       <a href="#tab-9297-1" data-toggle="tab" data-bs-toggle="tab" data-value="Data">Data</a>
#>     </li>
#>     <li>
#>       <a href="#tab-9297-2" data-toggle="tab" data-bs-toggle="tab" data-value="Grouping">Grouping</a>
#>     </li>
#>     <li>
#>       <a href="#tab-9297-3" data-toggle="tab" data-bs-toggle="tab" data-value="Aesthetic">Aesthetic</a>
#>     </li>
#>     <li>
#>       <a href="#tab-9297-4" data-toggle="tab" data-bs-toggle="tab" data-value="Line">Line</a>
#>     </li>
#>     <li>
#>       <a href="#tab-9297-5" data-toggle="tab" data-bs-toggle="tab" data-value="Labels">Labels</a>
#>     </li>
#>     <li>
#>       <a href="#tab-9297-6" data-toggle="tab" data-bs-toggle="tab" data-value="Axes">Axes</a>
#>     </li>
#>   </ul>
#>   <div class="tab-content" data-tabsetid="9297">
#>     <div class="tab-pane active" data-value="Data" id="tab-9297-1">
#>       <div class="row">
#>         <div class="col-sm-6">
...
#>       </div>
#>     </div>
#>     <div class="tab-pane" data-value="Grouping" id="tab-9297-2">
#>       <div class="row">
#>         <div class="col-sm-6">
#>           <div class="form-group shiny-input-container">
...
#>       </div>
#>     </div>
#>     <div class="tab-pane" data-value="Aesthetic" id="tab-9297-3">
#>       <div class="row">
#>         <div class="col-sm-6">
#>           <div class="form-group shiny-input-container">
...
#>       </div>
#>     </div>
#>     <div class="tab-pane" data-value="Line" id="tab-9297-4">
#>       <div class="row">
#>         <div class="col-sm-6">
#>           <div class="form-group shiny-input-container">
...
#>       </div>
#>     </div>
#>     <div class="tab-pane" data-value="Labels" id="tab-9297-5">
#>       <div class="row">
#>         <div class="col-sm-6">
#>           <div class="form-group shiny-input-container">
...
#>       </div>
#>     </div>
#>     <div class="tab-pane" data-value="Axes" id="tab-9297-6">
#>       <div class="row">
#>         <div class="col-sm-6">
#>           <div class="form-group shiny-input-container">
#>             <div class="checkbox">
...
#>     <div class="form-group shiny-input-container">
#>       <input id="BarPlot-auto.update" type="checkbox" class="sw-switchInput" data-input-id="BarPlot-auto.update" data-on-text="ON" data-off-text="OFF" data-label-text="Auto Update" data-label-width="auto" data-handle-width="auto" data-size="mini"/>
#>     </div>
#>   </div>
#>   <div class="col-sm-3" style="margin-top: 25px;">
