...
#> <div class="tabbable">
#>   <ul class="nav nav-tabs shiny-tab-input" id="linePlot-linePlotTabsetPanel" data-tabsetid="3824">
#>     <li class="active">
#>       <a href="#tab-3824-1" data-toggle="tab" data-bs-toggle="tab" data-value="Data">Data</a>
#>     </li>
#>     <li>
#>       <a href="#tab-3824-2" data-toggle="tab" data-bs-toggle="tab" data-value="Axes">Axes</a>
#>     </li>
#>   </ul>
#>   <div class="tab-content" data-tabsetid="3824">
#>     <div class="tab-pane active" data-value="Data" id="tab-3824-1">
#>       <div class="row">
#>         <div class="col-sm-6">
...
#>       </div>
#>     </div>
#>     <div class="tab-pane" data-value="Axes" id="tab-3824-2">
#>       <div class="row">
#>         <div class="col-sm-6">
#>           <div class="form-group shiny-input-container">
#>             <div class="checkbox">
