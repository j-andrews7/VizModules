...
#> <div class="tabbable">
#>   <ul class="nav nav-tabs shiny-tab-input" id="linePlot-linePlotTabsetPanel" data-tabsetid="1963">
#>     <li class="active">
...
#>     </li>
#>     <li>
#>       <a href="#tab-1963-4" data-toggle="tab" data-bs-toggle="tab" data-value="Axes">Axes</a>
#>     </li>
#>   </ul>
...
#>       </div>
#>     </div>
#>     <div class="tab-pane" data-value="Axes" id="tab-1963-4">
#>       <div class="row">
#>         <div class="col-sm-6">
#>           <div class="form-group shiny-input-container">
