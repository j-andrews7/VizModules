...
#> <div class="tabbable">
#>   <ul class="nav nav-tabs shiny-tab-input" id="histogram-histogramPlotTabsetPanel" data-tabsetid="8826">
#>     <li class="active">
...
#>     </li>
#>     <li>
#>       <a href="#tab-8826-4" data-toggle="tab" data-bs-toggle="tab" data-value="Rug">Rug</a>
#>     </li>
#>     <li>
#>       <a href="#tab-8826-5" data-toggle="tab" data-bs-toggle="tab" data-value="Axes">Axes</a>
#>     </li>
#>     <li>
#>       <a href="#tab-8826-6" data-toggle="tab" data-bs-toggle="tab" data-value="Lines">Lines</a>
#>     </li>
#>   </ul>
...
#>       </div>
#>     </div>
#>     <div class="tab-pane" data-value="Rug" id="tab-8826-4">
#>       <div class="row">
#>         <div class="col-sm-6">
#>           <div class="form-group shiny-input-container">
#>             <div class="material-switch">
...
#>       </div>
#>     </div>
#>     <div class="tab-pane" data-value="Axes" id="tab-8826-5">
#>       <div class="row">
#>         <div class="col-sm-6">
#>           <div class="form-group shiny-input-container">
#>             <div class="material-switch">
...
#>             <div class="checkbox">
#>               <label>
#>                 <input id="histogram-show.major.grid.x" type="checkbox" class="shiny-input-checkbox" checked="checked"/>
...
#>             <div class="checkbox">
#>               <label>
#>                 <input id="histogram-show.major.grid.y" type="checkbox" class="shiny-input-checkbox" checked="checked"/>
...
#>       </div>
#>     </div>
#>     <div class="tab-pane" data-value="Lines" id="tab-8826-6">
#>       <div class="row">
#>         <div class="col-sm-6">
#>           <div class="form-group shiny-input-container">
...
#>         <div class="col-sm-6">
#>           <div class="form-group shiny-input-container">
#>             <label class="control-label" id="histogram-abline.slopes-label" for="histogram-abline.slopes">Slopes</label>
...
#>   </div>
#>   <div class="col-sm-2" style="margin-top: 25px;">
#>     <button id="histogram-update" style="width:100%;" type="button" class="btn btn-default action-button">
#>       <span class="action-label">Update</span>
#>     </button>
#>   </div>
#>   <div class="col-sm-2" style="margin-top: 25px;">
#>     <button class="btn btn-default action-button btn-secondary" id="histogram-reset" style="width:100%;" type="button">
