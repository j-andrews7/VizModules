...
#> <div class="tabbable">
#>   <ul class="nav nav-tabs" data-tabsetid="5775">
#>     <li class="active">
#>       <a href="#tab-5775-1" data-toggle="tab" data-bs-toggle="tab" data-value="Personal">Personal</a>
#>     </li>
#>     <li>
#>       <a href="#tab-5775-2" data-toggle="tab" data-bs-toggle="tab" data-value="Settings">Settings</a>
#>     </li>
#>   </ul>
#>   <div class="tab-content" data-tabsetid="5775">
#>     <div class="tab-pane active" data-value="Personal" id="tab-5775-1">
#>       <div class="row">
#>         <div class="col-sm-12">
#>           <div class="form-group shiny-input-container">
...
#>       </div>
#>     </div>
#>     <div class="tab-pane" data-value="Settings" id="tab-5775-2">
#>       <div class="row">
#>         <div class="col-sm-12">
#>           <div class="form-group shiny-input-container">
#>             <div class="checkbox">
