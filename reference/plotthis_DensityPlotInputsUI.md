...
#> <div class="tabbable">
#>   <ul class="nav nav-tabs shiny-tab-input" id="densityPlot-DensityPlotTabsetPanel" data-tabsetid="1947">
#>     <li class="active">
#>       <a href="#tab-1947-1" data-toggle="tab" data-bs-toggle="tab" data-value="Data">Data</a>
#>     </li>
#>     <li>
#>       <a href="#tab-1947-2" data-toggle="tab" data-bs-toggle="tab" data-value="Facet">Facet</a>
#>     </li>
#>     <li>
#>       <a href="#tab-1947-3" data-toggle="tab" data-bs-toggle="tab" data-value="Aesthetics">Aesthetics</a>
#>     </li>
#>     <li>
#>       <a href="#tab-1947-4" data-toggle="tab" data-bs-toggle="tab" data-value="Rug">Rug</a>
#>     </li>
#>     <li>
#>       <a href="#tab-1947-5" data-toggle="tab" data-bs-toggle="tab" data-value="Axes">Axes</a>
#>     </li>
#>     <li>
#>       <a href="#tab-1947-6" data-toggle="tab" data-bs-toggle="tab" data-value="Lines">Lines</a>
#>     </li>
#>   </ul>
#>   <div class="tab-content" data-tabsetid="1947">
#>     <div class="tab-pane active" data-value="Data" id="tab-1947-1">
#>       <div class="row">
#>         <div class="col-sm-6">
...
#>       </div>
#>     </div>
#>     <div class="tab-pane" data-value="Facet" id="tab-1947-2">
#>       <div class="row">
#>         <div class="col-sm-6">
#>           <div class="form-group shiny-input-container">
...
#>       </div>
#>     </div>
#>     <div class="tab-pane" data-value="Aesthetics" id="tab-1947-3">
#>       <div class="row">
#>         <div class="col-sm-6">
#>           <div class="form-group shiny-input-container">
...
#>       </div>
#>     </div>
#>     <div class="tab-pane" data-value="Rug" id="tab-1947-4">
#>       <div class="row">
#>         <div class="col-sm-6">
#>           <div class="form-group shiny-input-container">
#>             <div class="material-switch">
...
#>       </div>
#>     </div>
#>     <div class="tab-pane" data-value="Axes" id="tab-1947-5">
#>       <div class="row">
#>         <div class="col-sm-6">
#>           <div class="form-group shiny-input-container">
#>             <div class="material-switch">
...
#>       </div>
#>     </div>
#>     <div class="tab-pane" data-value="Lines" id="tab-1947-6">
#>       <div class="row">
#>         <div class="col-sm-6">
#>           <div class="form-group shiny-input-container">
