...
#' Example matrix-style data frame for the ComplexHeatmap module
#'
#' A tidy data frame derived from a column-scaled (z-scored) `mtcars`. The
#' numeric columns form a matrix suitable for [ComplexHeatmap::Heatmap()], and
#' the `sample` column supplies row-name identifiers.
#'
#' @format A data frame with 32 rows and 12 columns:
#' \describe{
#'   \item{sample}{Car model name (character), used as row identifier}
#'   \item{mpg, cyl, disp, hp, drat, wt, qsec, vs, am, gear, carb}{Column-scaled
#'     (z-scored) numeric values from the classic `mtcars` dataset}
#' }
#'
#' @source Generated by column-scaling the classic mtcars dataset.
#'
#' @author Jacob Martin
#' @keywords datasets
"example_matrix_df"
