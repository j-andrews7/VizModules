...
#' @param show.major.grid.x Logical, whether to show major gridlines on the x-axis. Default: TRUE.
#' @param show.major.grid.y Logical, whether to show major gridlines on the y-axis. Default: TRUE.
...
linePlot <- function(reactive.data, x, y, plot.mode, line.type, colour.group.by, palette.selection, show.legend, facet.by = NULL,
                     ...
                     axis.tickcolor = "black", axis.ticklen = 5, axis.tickwidth = 1, show.major.grid.x = TRUE, show.major.grid.y = TRUE,
    ...
    xaxis_style <- list(
        ...
        title = x.title, autorange = TRUE, showgrid = show.major.grid.x
    )
    ...
    yaxis_style$showgrid <- show.major.grid.y
