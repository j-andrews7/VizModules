...
#'   \item \code{show.major.grid.x} - Show X-axis major gridlines (UI: "Show X Gridlines", default: TRUE)
#'   \item \code{show.major.grid.y} - Show Y-axis major gridlines (UI: "Show Y Gridlines", default: TRUE)
