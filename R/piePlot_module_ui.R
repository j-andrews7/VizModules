...
piePlotInputsUI <- function(id, data, defaults = NULL, title = NULL, columns = 2) {
    ...
    organize_inputs(
        ...
        tack = tagList(
            fluidRow(
                column(2, switchInput(ns("use.update.button"), "Require Update", value = TRUE, size = "mini", onLabel = "ON", offLabel = "OFF"), style = "margin-top: 25px;"),
                column(2, actionButton(ns("update"), "Update Plot", width = "100%"), style = "margin-top: 25px;"),
                column(2, actionButton(ns("reset"), "Reset Defaults", class = "btn-secondary", width = "100%"), style = "margin-top: 25px;"),
