    ...
    inputs <- list(
        ...
        "Adjustments" = tagList(
            tipify(shiny::selectInput(ns("sort_x"), "Sort X By", c(
                ...
                "median_desc", "median"
            ), selected = "none"), documentParameters$sort_x, placement = "top"),
            ...
            tipify(numericInput(ns("jitter.height"), "Jitter Height", min = 0, max = 1, value = 0),
                documentParameters$jitter_height, placement = "top"),
