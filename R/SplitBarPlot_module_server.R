...
#' [vizModules::SplitBarPlotInputsUI()], [vizModules::SplitBarPlotOutputUI()],
#' [vizModules::SplitBarPlotApp()]
#'
#' @export
#' @author Jacob Martin
SplitBarPlotServer <- function(id, data, hide.inputs = NULL, hide.tabs = NULL) {
