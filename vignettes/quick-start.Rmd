...
- **Reactive defaults**: An entry may be a `reactive()` instead of a fixed value, so an input follows your app's state (e.g. `defaults = list(main = reactive(input$sample))`). See `vignette("defaults-and-hiding", package = "VizModules")`.
