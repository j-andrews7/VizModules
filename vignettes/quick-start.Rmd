...
We created `create_interactive_summary_download_handler()` to create a compact record of the plotted data, stats, UI inputs, and the rendered plot. 
The function requires a reactive plotly plot and a filename base; however the outputed summary can be optionally enriched by both a stats reactive and a 
UI inputs reactive. 
