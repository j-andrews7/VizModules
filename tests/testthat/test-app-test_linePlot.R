...
test_that("{shinytest2} recording: test_linePlot", {
	...
	app <- AppDriver$new(
		test_path("../../inst/apps/test_linePlot"),
		name = "test_linePlot",
		seed = 7,
		height = 911,
		width = 1619
	...
	app$set_inputs(
		`iris-linePlot__shinyjquiBookmarkState__resizable` = c(1039.33, 400),
		allow_no_input_binding_ = TRUE
	)

	app$set_inputs(
		`iris-linePlot_size` = c(1039.33, 400),
		allow_no_input_binding_ = TRUE
	)

	app$set_inputs(
		`iris-linePlot_is_resizing` = FALSE,
		allow_no_input_binding_ = TRUE
	)

	app$set_inputs(
		`mtcars-linePlot__shinyjquiBookmarkState__resizable` = c(1039.33, 400),
		allow_no_input_binding_ = TRUE
	)

	app$set_inputs(
		`mtcars-linePlot_size` = c(1039.33, 400),
		allow_no_input_binding_ = TRUE
	)

	app$set_inputs(
		`mtcars-linePlot_is_resizing` = FALSE,
		allow_no_input_binding_ = TRUE
	)
	...
	app$set_inputs(
		`plotly_afterplot-A` = "\"mtcars-linePlot\"",
		allow_no_input_binding_ = TRUE,
		priority_ = "event"
	)

	app$set_inputs(
		`plotly_afterplot-A` = "\"iris-linePlot\"",
		allow_no_input_binding_ = TRUE,
		priority_ = "event"
	)
