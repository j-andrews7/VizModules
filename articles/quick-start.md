...
1.  Open the module input help page, e.g., `?scatterPlotInputsUI` or
    `?AreaPlotInputsUI`. The **Details** section notes which arguments
    from the underlying plot function are wired through and any that are
