...
1.  Open a scatter plot app
    (e.g. [`dittoViz_scatterPlotApp()`](https://j-andrews7.github.io/VizModules/dev/reference/dittoViz_scatterPlotApp.md)).
...
| Scenario | Where to call [`register_model_backend()`](https://j-andrews7.github.io/VizModules/dev/reference/register_model_backend.md) |
|----|----|
| Built into VizModules | Add to `.register_builtin_backends()` in `R/model_backends.R` |
| Extension package | Your package’s [`.onLoad()`](https://j-andrews7.github.io/VizModules/dev/reference/dot-onLoad.md) in `R/zzz.R` |
...
| [`list_model_backends()`](https://j-andrews7.github.io/VizModules/dev/reference/list_model_backends.md) | List all registered backend names |
| [`build_model_row_spec()`](https://j-andrews7.github.io/VizModules/dev/reference/build_model_row_spec.md) | Build a merged row_spec from all backends (used internally by the scatter UI) |
