...
| `palette_options` | Named list of palettes (each a character vector of colors). Defaults to [`default_palettes()`](https://j-andrews7.github.io/VizModules/dev/reference/default_palettes.md). |
