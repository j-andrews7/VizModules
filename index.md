...
[plotthis](https://github.com/pwwang/plotthis) packages to create
...
These modules will contain all possible functionality from **dittoViz**
and **plotthis** with some additional parameters that make use of the
interactive features of plotly, e.g. interactive text annotations,
arbitrary shape annotations, multiple download formats, etc.
...
following dittoViz visualization functions:
...
This package is based on [dittoViz](https://github.com/dtm2451/dittoViz)
and modules will be developed for all plot types generated by that
package, including:
...
in plotly, e.g. interactive ridgeplots that are available from
